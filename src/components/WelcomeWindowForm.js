export default function WelcomeWindowForm({ children, heading, isProcessLoading, btnSubmit, btnAriaLabel, onSubmit, isValid }) {
    ...
    return (
        <div className="welcome-window">
            ...
            <form className="welcome-window__form"
                  onSubmit={onSubmit}
            >
                <fieldset className="welcome-window__fieldset-user">
                    {inputs}
                </fieldset>
                <button
